...
class CredentialsManager:
    ...
    def _load_credentials(self):
        ...
        try:
            ...
            if file_path and os.path.exists(file_path):
                logger.warning("⚠️  Loading credentials from file path (deprecated). Consider using base64 encoding.")
            ...
            logger.warning("⚠️  No explicit service account found. Using default Google Cloud credentials.")
    ...
    def get_fresh_credentials(self) -> Optional[service_account.Credentials]:
        ...
        if not self._service_account_info:
            logger.warning("⚠️  No service account info available for fresh credentials")
